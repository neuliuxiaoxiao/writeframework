...
public class koalasRequest implements org.apache.thrift.TBase<koalasRequest, koalasRequest._Fields>, java.io.Serializable, Cloneable {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("koalasRequest");
    ...
    public int compareTo(koalasRequest other) {
        ...
        koalasRequest typedOther = (koalasRequest)other;
    ...
    private static class koalasRequestStandardScheme extends StandardScheme<koalasRequest> {

        public void read(org.apache.thrift.protocol.TProtocol iprot, koalasRequest struct) throws org.apache.thrift.TException {
    ...
    private static class koalasRequestTupleScheme extends TupleScheme<koalasRequest> {
