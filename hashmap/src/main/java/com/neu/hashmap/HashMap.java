...
public class HashMap<K,V> implements Map<K,V> {
    ...
    public HashMap(int defaultInitCapacity, float defaultLoadFactor) {
        ...
        if (defaultLoadFactor<=0||Float.isNaN(defaultLoadFactor)){
            throw new IllegalArgumentException("Illegal load factory:"+defaultLoadFactor);
        }
