package com.neu.spi.loader;

import com.neu.spi.annotation.Spi;
import com.neu.spi.util.Holder;
...
public class ExtensionLoader<T> {
    ...
    //定义spi文件的扫描路径
    private static final String NEU_DIRECTORY="META-INF/neu/";
    //分割spi上默认拓展字符串用的
   ...
   //这两个缓存文字比较难描述,debug或者搜索一下调用就知道是缓存什么的了
    ...
    private Map<String, Class<?>> loadExtensionClasses() {
        ...
        loadFile(extensionClasses, NEU_DIRECTORY);
